...
public class Project extends JFrame implements ActionListener 
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(msg.equals("Notepad"))
        {
            try
            {
                Runtime.getRuntime().exec("notepad.exe");//correct the path
            }
            catch(Exception e){}
        }
        else if(msg.equals("Calculator"))
        {
            try
            {
                Runtime.getRuntime().exec("calc.exe");//correct the path
            }
            catch(Exception e){}
        }
        else if(msg.equals("Web Browser"))
        {
            try
            {
                Runtime.getRuntime().exec("browser path");//correct the path
            }
            catch(Exception e){}
        }
